...
create table if not exists artist_genre (artist_id integer references not null unique artist(id),
...
create table if not exists artist_album (artist_id integer not null unique references artist(id),
...
create table if not exists collections_track (collections_id integer not null unique references collections(id),
